    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Team-Profil <small>Hier siehst du alles &uuml;ber das Turnier!</small></h1>
                    <ol class="breadcrumb">
                        <li><a href="../../">Home</a></li>
                        <li><a href="../../tournaments">Team</a></li>
                        <li class="active">Team-Profil</li>
                    </ol>
                </div>
