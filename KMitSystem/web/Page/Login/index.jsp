      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="active"><a href="../Login/index.jsp">Login</a></li>
        ...
        <div class="col-lg-12">
           <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div align="center">
                ...
                <br>  
                <form class="form-signin" action="../Turnier-Dashboard/index.jsp" method="post" role="form">
                ...
                <a href="../../Page/FAQ/index.jsp" class="pull-right need-help">Brauchst du Hilfe? </a><span class="clearfix"></span>
            	<br>
                <a href="../../Page/Register/index.jsp" class="text-center new-account">Noch nicht angemeldet? Jetzt account erstellen! </a>
       	 </div>
        </div>
