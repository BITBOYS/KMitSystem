      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="../Register/index.jsp">Sign Up</a></li>        
            <li class="dropdown">
      ...
      <div class="row">
        ...
        <div align="center">	
          	<div class="col-sm-6 col-md-4 col-md-offset-4">
                ...
                <br>   
	            <form action="../Login/index.jsp" method="post" class="form" role="form">
	            <div class="row">
	                <div class="col-md-12">
            	...
            	<br>
            	<a href="../../Page/Login/index.jsp" class="text-center new-account">Schon angemeldet? Jetzt einloggen! </a>
        	</div>
