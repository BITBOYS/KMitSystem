            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <ul id="myTab" class="nav nav-tabs">
                        <li class="active"><a href="#statistik" data-toggle="tab">Gesamtstatistik</a></li>
                        <li><a href="#user" data-toggle="tab">Memberstatistik</a></li>
                        <li><a href="#team" data-toggle="tab">Teamstatistik</a></li>
                    </ul>
